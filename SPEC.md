...
Three lines in this block are amendments awaiting sign-off: `setup` (Amended APRV-79, pending sign-off), `env` (Amended APRV-73, pending sign-off), and `mcp serve` (Amended APRV-103, pending sign-off).
