...
const FIXTURES: readonly Fixture[] = [
  ...
  { command: "git push --mirror origin", class: "vcs.history.rewrite", rule: "git-push-force", row: "git-push" },
  { command: "git push origin refs/tags/v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin HEAD:refs/tags/v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin refs/tags/v1.2.3:release-copy", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin v1.2.3-rc.1+build.7", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin tag v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin tag release-candidate", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin --tags", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push --follow-tags origin feature", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push --delete origin refs/tags/v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin :refs/tags/v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin :v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push origin feature v1.2.3", class: "release.publish", rule: "git-push-tag", row: "git-push" },
  { command: "git push --force origin refs/tags/v1.2.3", class: "vcs.history.rewrite", rule: "git-push-force", row: "git-push" },
  { command: "git push origin +feature refs/tags/v1.2.3", class: "vcs.history.rewrite", rule: "git-push-force", row: "git-push" },
  { command: "git push origin +feature:refs/tags/v1.2.3", class: "vcs.history.rewrite", rule: "git-push-force", row: "git-push" },
  { command: "git push origin refs/heads/v1.2.3", class: "vcs.push.branch", rule: "git-push-branch", row: "git-push" },
  { command: "git push origin release/v1.2.3", class: "vcs.push.branch", rule: "git-push-branch", row: "git-push" },
  { command: "git push origin v1.2", class: "vcs.push.branch", rule: "git-push-branch", row: "git-push" },
