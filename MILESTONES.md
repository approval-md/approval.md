...
| M6 | `m-8` | M6 - Backlog.md round-trip and AGENTS.md import | done (one human filing step open) | Round-trip writer, envelope write-back, envelope-loss detection, AGENTS.md import, format-fixture drift guard |
