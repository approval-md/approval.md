...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 A private archival mirror of https://github.com/MrLesk/Backlog.md exists (git clone --mirror pushed to a private repo, or a local bare mirror), documented as disaster-recovery only, not a development fork
