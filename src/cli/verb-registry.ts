...
const VERBS: VerbSpec[] = [
...

  {
    ...
    error: ERROR_SCHEMA,
    exit_codes: [
      { code: 0, meaning: "every verdict, allow AND deny: the {action, message} object on stdout is the answer, and a post_tool_call counterpart reports on stderr at 0 as well" },
      { code: 2, meaning: "the hook is misconfigured (a usage error before any event was read); no verdict was printed" },
    ],
  },
